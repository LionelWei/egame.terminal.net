...
public class ELog {
    ...
    public static Printer getLocalPrinter() {
        return getLocalPrinter(TAG);
    }

    public static Printer getLocalPrinter(String tag) {
